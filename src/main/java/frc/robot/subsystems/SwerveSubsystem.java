...
public class SwerveSubsystem extends SubsystemBase {
    ...
    public SwerveSubsystem(File directory) {
        ...
        setupPathPlanner(); /* this calls the holonomic config */
    ...
    public void setupPathPlanner() {
        AutoBuilder.configureHolonomic(
                ...
                new HolonomicPathFollowerConfig(
                    // translation pid
                    Constants.DriveBase.Auto.translationPID,
                    // rotation pid
                    Constants.DriveBase.Auto.rotationPID,
                    // max speed
                    maximumSpeed,
                ...
                () -> {
                    ...
                    // alliance
                    return Constants.Robot.isRedAlliance;
                },
    ...
    public Command driveToPose(Pose2d pose) {
        ...
        PathConstraints constraints = new PathConstraints(
                ...
                swerveDrive.getMaximumAngularVelocity(), Units.degreesToRadians(90));
